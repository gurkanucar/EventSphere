...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request object for updating an existing role.")
public class UpdateRoleRequest {

    @Size(min = 2, max = 100, message = "Role name must be between 2 and 100 characters")
    @Schema(description = "Role name (ROLE_ prefix will be added automatically if not present)", example = "ADMIN")
    private String name;
